...
async def run_query(user_query):
    ...
    # [Step 6, Task 5.4] — scratchpad persistence
    ...
    # [Step 4, Task 2.1] — MCP tool guidance in system prompt
    mcp_tool_guidance = (
    ...
    # [Step 5, Task 1.3] — Explore subagent guidance in system prompt
    explore_guidance = (
        "## Delegation\n\n"
    ...
    # [Step 4, Task 2.4] — MCP documentation server
    ...
    # [Step 5, Task 1.3] — Explore subagent
    ...
    # [Step 4] — MCP docs tool
    allowed_tools.append("mcp__docs__lookup_docs")
    # [Step 5] — Agent tool for subagent spawning
