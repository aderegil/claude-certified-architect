...
![Lab 03 screenshot](_manage/screenshot.png)
...
Restores all modified files to their original starter state with TODOs intact and removes the `output/` directory. Your `.env` file is preserved — no need to re-enter your API key.
