...
This restores `pipeline.py`, `prompts/review_prompt.txt`, and `CLAUDE.md` to their starter state with TODOs, and deletes the `output/` directory. Your `.env` file is preserved — no need to re-enter your API key.
