...
**Scenario:** S2 — Code Generation Workflows
**Domains:** D3 · D5
...
First, create a coding standards file to import. Create `coding_standards.md` at the lab root:
...
If sample_app.py was modified by the previous steps, you can restore it from `reset.zip`:
