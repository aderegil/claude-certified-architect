...
This restores `main.py` and `schema.py` to their original starter state with TODOs. Your `.env` file is preserved — no need to re-enter your API key.
